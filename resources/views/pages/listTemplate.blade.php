...
@endif
                ...
                <div class="card-header d-flex justify-content-between">
                    <div class="d-flex justify-content-right">
                        ...
                        <a href="{{route('createtemplate')}}" class="btn btn-primary "><i class="material-icons-outlined">add</i>Add</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                                       ...
                                       <tr>
                                           ...
                                           <td>
                                               <div class="d-flex justify-content-center">
                                                   <a class="btn btn-success btn-sm mx-3" href="{{route('createtemplate')}}/{{$tag->id}}">Edit</a>
                                                   <form action="{{route('deleteTemplate')}}" method="POST" onsubmit="return confirm('do you sure want to delete this template')">
                                                    @method('delete')
                                                    @csrf
