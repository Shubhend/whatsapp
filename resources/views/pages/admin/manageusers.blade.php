        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="" method="POST" enctype="multipart/form-data" id="formUser">
                    ...
                    <label for="credit" class="form-label" id="labelcredit">Add Credit</label>
                    <input type="number" name="credit" id="credit" class="form-control" value="" placeholder="">
        ...
        // return;
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#labelcredit').html('Add Credit *(leave blank if not change)');
