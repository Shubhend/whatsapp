<x-layout-dashboard title="Rest Api">
    <div class="app-content">
        <div class="content-wrapper">
            <div class="container">
                <h2 class="my-5">Rest API / WatzApi App</h2>
                            ...
                            <table class="table">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col">JSON / HTTP X-FormEncoded</th>
                                    </tr>
                                    <tr>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-body">
                                <p class="card-description">Rest Api / WatzApi App </p>
...
<pre class="hljs" style="display: block; overflow-x: auto; padding: 0.5em; background-color: rgb(63, 63, 63); color: rgb(220, 220, 220);"><span class="xml"><span class="php"><span class="hljs-meta" style="color: rgb(127, 159, 127);">&lt;?php</span>
    ...
    <span class="hljs-meta" style="color: rgb(127, 159, 127);">?&gt;</span></span></span></pre>
                                            ...
                                            {{-- end generate qr --}}
                                            <pre class="tab-pane fade show" id="webhook" role="tabpanel" aria-labelledby="pills-contact-tab">
