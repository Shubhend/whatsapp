...
Copyright By Devendra Ausar, WatzApi App
Email : divineinfosec2019@gmail.com / info@divineinfosec.com
Whatsap : 918819801555
------------------------------------------------------------------
...
<head>
    ...
    <meta name="description" content="WATZAPI APP V1.0.0 ,Whatsapp gateway Android based WHATSAPP MARKETING TOOL">
    <meta name="csrf-token" content="{{ csrf_token() }}" />
    <meta name="keywords" content="waapi,wa gateway, whatsapp blast, divine infosec, watzapi app, whatsapp android app, whatsapp marketing android app, ">
    <meta name="author" content="Devendra Ausar , WatzApi APP">
    <title>{{ $title }} | WATZAPI APP</title>
