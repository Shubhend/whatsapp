<head>
    ...
    <meta name="description" content="WatzApi App Divine Infosec V1.0.0 ,Whatsapp gateway Multi device Android App">
    <meta name="csrf-token" content="{{ csrf_token() }}" />
    <meta name="keywords" content="waapi,wa gateway, whatsapp blast, watzapi, watz api app, Divine Infosec, wa gateway watzapi app, ">
    <meta name="author" content="Devendra Ausar , Divine Infosec">
    <!-- The above 6 meta tags *must* come first in the head; any other head content must come *after* these tags -->

    <!-- Title -->
    <title>{{ $title }} | WAPP</title>
